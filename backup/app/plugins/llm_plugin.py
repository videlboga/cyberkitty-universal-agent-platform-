...
class LLMPlugin(PluginBase):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.api_url = config.get('api_url') or os.getenv("OPENROUTER_URL", "https://openrouter.ai/api/v1/chat/completions")
        self.default_model = config.get('default_model') or "openai/gpt-3.5-turbo"
        
        logger.info("LLMPlugin инициализирован")
