...
class MongoStoragePlugin(PluginBase):
    ...
    async def handle_insert_one(self, step_data: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def handle_find_one(self, step_data: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        params = _resolve_value_from_context(step_data.get("params", {}), context)
        collection_name = params.get("collection_name")
    ...
    async def handle_update_one(self, step_data: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        params = _resolve_value_from_context(step_data.get("params", {}), context)
        collection_name = params.get("collection_name")
        query = params.get("query")
        ...
        try:
            collection = self._get_collection(collection_name)
            result: UpdateResult = collection.update_one(query, update_data)
    ...
    async def handle_delete_one(self, step_data: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        params = _resolve_value_from_context(step_data.get("params", {}), context)
        collection_name = params.get("collection_name")
        query = params.get("query")
